            ...
            <>
              ...
              <div className="flex justify-between items-start mb-6 mt-2">
                <div>
                  ...
                  <h2 className="text-2xl font-black text-gray-900 dark:text-white tracking-tight">VTEXT - {data.idoperacion || token}</h2>
                </div>
              ...
              {tecnico && status !== 'finalizada' && (
                <div className="flex items-center gap-4 bg-gray-50 dark:bg-muted/40 p-4 rounded-[20px] mb-8 border border-gray-100 dark:border-border/50">
                  <div className="w-14 h-14 rounded-full bg-gray-200 dark:bg-gray-700 flex items-center justify-center shrink-0 shadow-sm overflow-hidden">
                  ...
                  <button 
                    onClick={() => window.open('tel:017546000')}
                    className="w-12 h-12 rounded-full border border-[#FF5A1F] text-[#FF5A1F] flex items-center justify-center hover:bg-[#FF5A1F]/10 transition-colors"
                  >
              ...
              <div className="relative pl-[22px] border-l-2 border-gray-200 dark:border-gray-800 ml-4 space-y-8 mb-10 mt-6">
                {steps.map((step, i) => {
                  ...
                  return (
                    <div key={step.id} className="relative">
                      ...
                      <div className="-mt-1.5">
                        ...
                        <p className={`text-[12px] font-medium leading-tight ${isCurrent ? 'text-gray-600 dark:text-gray-300' : 'text-gray-400'}`}>
                          {step.sub}
                        </p>
                        {step.date && i === 0 && (
              ...
              {status !== 'finalizada' && status !== 'cerrada' && (
                <div className="flex gap-3 pt-4 border-t border-gray-100 dark:border-border/50">
                  <button 
                    ...
                    className="flex-1 bg-gray-900 text-white dark:bg-white dark:text-black h-12 rounded-full text-[13px] font-bold active:scale-95 transition-transform shadow-lg shadow-black/10"
                  >
                    Reprogramar solicitud
                  </button>
                  <button 
                    onClick={() => setIsCancelModalOpen(true)}
                    className="w-12 h-12 bg-white dark:bg-card border-2 border-gray-200 dark:border-gray-800 text-gray-600 dark:text-gray-400 rounded-full flex items-center justify-center active:scale-95 transition-transform"
                  >
        ...
        {isReprogramModalOpen && (
          ...
          >
            <motion.div
              ...
              className="bg-white dark:bg-card p-6 sm:p-8 rounded-t-[2rem] sm:rounded-[2rem] shadow-2xl max-w-lg w-full"
            >
