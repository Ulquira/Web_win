# C�digo Frontend de Referencia

Este archivo contiene la estructura principal de la aplicaci�n React (p�ginas, mapa y hooks) para que puedas copiarlo y usarlo como plantilla en otros proyectos.
...
## src\components\seguimiento\TrackingMap.tsx
\\\	sx
