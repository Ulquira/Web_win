...
const newHeader = `      <header className="bg-gradient-to-r from-primary via-primary/90 to-primary-light text-primary-foreground py-6 shadow-xl relative overflow-hidden border-b-4 border-secondary">
          ...
          <div className="flex justify-between items-center mb-8">
            <div className="flex items-center gap-6">
              <div className="flex items-center cursor-pointer" onClick={() => navigate('/')}>
                <img src="/src/assets/logo-1.png" alt="Peru Fibra" className="h-8 md:h-10 lg:h-12 w-auto object-contain drop-shadow-lg transition-all" />
              </div>
...
fs.writeFileSync('src/pages/Seguimiento.tsx', top + newHeader + bottom);
